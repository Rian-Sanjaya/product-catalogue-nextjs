                  ...
                  <div className={styles.item_card}>
                    ...
                    <div className={styles.item_info}>
                      <div className={`${styles.stack} ${styles.horizontal} ${styles.bulleted}`}>
                        <span className={styles.text_tertiary}>{product.brand}</span>
                        <span className={styles.text_tertiary}>
                          <a className={styles.text_tertiary} href="#">{product.category}</a>
                        </span>
                      </div>
                      <div className={`${styles.stack} ${styles.horizontal}`}>
                        <div className={styles.text_ellipsis}>
                          <span className={styles.text_secondary}>{product.name}</span>
                        </div>
                        <div className={styles.text_secondary}>{`$${product.price}`}</div>
                      </div>
                    </div>
                  </div>
                </div>
